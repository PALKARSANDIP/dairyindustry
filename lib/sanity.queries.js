...
import { client, projectId, dataset, apiVersion } from './sanity.client'
import { createClient } from 'next-sanity'

// Non-CDN client for sitemap/SSR queries that need fresh data
const freshClient = createClient({ projectId, dataset, apiVersion, useCdn: false })
...
// ── Fetch all slugs (for static site generation + sitemap) ──
