    ...
    <div style={{ paddingTop: 90 }}>
      ...
      <section style={{ padding: '56px 0', background: '#FFF8EE', textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto', padding: '0 16px' }}>
          ...
          <a href="https://forms.gle/XbNZWHxgzrxKC4YW8" target="_blank" rel="noopener noreferrer" className="btn-gold" style={{ padding: '14px 36px', borderRadius: 999, fontSize: 17, textDecoration: 'none', gap: 8, boxShadow: '0 4px 20px rgba(212,160,23,0.4)' }}>
