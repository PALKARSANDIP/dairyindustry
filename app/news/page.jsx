      ...
      <section style={{ padding: '56px 0', background: '#1A3A5C', textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto', padding: '0 16px' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="https://exporegistration.in/expo-visitor.aspx" target="_blank" rel="noopener noreferrer" className="btn-gold" style={{ padding: '12px 28px', borderRadius: 999, fontSize: 14, textDecoration: 'none', gap: 8 }}>
